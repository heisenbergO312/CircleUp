    ...
    try {
        ...
        const response = await axios({
            ...
            data: {
                ...
                subject: 'Registration OTP CircleUp',
                htmlContent: `<p>Your registration otp for CircleUp is ${otp}</p>`,
                replyTo: {
                    email: 'heisenberg.03123@gmail.com',
                    name: 'CircleUp'
                }
    ...
    try {
        ...
        const response = await axios({
            ...
            data: {
                ...
                subject: 'Reset Password OTP CircleUp',
                htmlContent: `<p>Your reset password otp for CircleUp is ${otp}</p>`,
                replyTo: {
                    email: 'heisenberg.03123@gmail.com',
                    name: 'CircleUp'
                }
